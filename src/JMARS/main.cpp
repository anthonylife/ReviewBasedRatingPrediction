...
///////////////////////////////////////////////////////////////////
// Date: 2014/12/16                                              //
// Running corresponding model (JMARS)                           //
///////////////////////////////////////////////////////////////////
...
void print_usage_and_exit() {
    ...
    printf("***** Jointly Modeling Aspects, Ratings and Sentiments for Rating Prediction****\n");
...
int main(int argc, char **argv) {
    ...
    if (data_num!=0 && data_num!=1 && data_num!=2 && data_num!=3 && data_num!=4 && data_num!=5) {
        ...
        submission_path = "../../results/jmars_result1.dat";
    } else if (data_num==1) {
        ...
        submission_path = "../../results/jmars_result2.dat";
    } else if (data_num==2) {
    ...
    utils::tic(start_t);
    JMARS *model = new JMARS((char *)trdata_path.c_str(),
