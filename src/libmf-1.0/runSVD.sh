...
#./libmf train --tr-rmse --obj -k 40 -t 400 -s 1 -p 0.1 -q 0.1 -g 0.001 -blk 1x1 -ub 0.1 -ib 0.1 --no-rand-shuffle ./yelp_train.bin ./yelp_svd.model
...
./libmf train --tr-rmse --obj -k 40 -t 400 -s 1 -p 0.1 -q 0.1 -g 0.01 -blk 1x1 -ub 0.1 -ib 0.1 --no-use-avg --no-rand-shuffle ./amazonfood_train.bin ./amazonfood_svd.model
