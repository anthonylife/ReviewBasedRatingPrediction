...
./libmf train --tr-rmse --obj -k 20 -t 200 -s 1 -p 0.1 -q 0.1 -g 0.02 -blk 1x1 -ub -1 -ib -1 --no-user-bias --no-item-bias --no-use-avg --no-rand-shuffle ./yelp_train.bin ./yelp_pmf.model
...
./libmf train --tr-rmse --obj -k 20 -t 200 -s 1 -p 0.01 -q 0.01 -g 0.02 -blk 1x1 -ub -1 -ib -1 --no-user-bias --no-item-bias --no-use-avg --no-rand-shuffle ./amazonfood_train.bin ./amazonfood_pmf.model
